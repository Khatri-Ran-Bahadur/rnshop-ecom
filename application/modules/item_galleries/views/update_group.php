 ...
 ?>
  ...
  <p style="margin-top: 30px;">
    <a href="<?= base_url() ?>store_items/create/<?= $parent_id ?>"><button type="button" class="btn btn-default">Previous Page</button></a>
  	...
  	<a href="<?= base_url() ?>item_galleries/upload_image/<?= $parent_id ?>" role="button" class="btn btn-primary">Upload Picture</a>
		...
		<div class="box-content">
			<table class="table table-striped table-bordered">
			  ...
			  ?>
				<tr>
					<td><?php if($picture!='') { ?>
						<img src="<?= $pic_path ?>" class="img-responsive img-thumbnail"><?php } ?>
					</td>
