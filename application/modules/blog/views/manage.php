...
if(isset($flash)){
 ...
 $create_page_url=base_url()."blog/create"; ?><p style="margin-top: 30px;">
...
<div class="box-content">
	<table class="table table-striped table-bordered">
	  ...
	  <tbody>
	  	...
	  	$view_page_url= base_url()."blog/article/".$row->page_url;
	  ...
	  ?>
		<tr>
			<td><img src="<?= $thumbnail_path ?>" class="img-responsive img-thumbnail"></td>
