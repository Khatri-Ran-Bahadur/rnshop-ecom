...
if(isset($flash)){
 ...
 $create_item_url=base_url()."homepage_blocks/create"; ?><p style="margin-top: 30px;">
	<a href="<?= $create_item_url ?>"><button type="button" class="btn btn-primary">Create New Homepage Offers Block</button></a>
</p>
