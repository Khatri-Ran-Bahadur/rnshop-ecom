...
function delete($update_id)
{
  if(!is_numeric($update_id)){
   ...
   }elseif ($submit=='Yes -Delete Offer Blog') {
     # code... 
    $this->_process_delete($update_id);

    $flash_msg="The Offer block was successfull deleted.";
...
{
    //draw the offers blocks that are on the homepage
 ...
 function create()
    {
        ...
        //process The form
            ...
            //get the variable
                ...
                if(is_numeric($update_id)){
                //update the data homepage offer
                    $this->_update($update_id, $data);
