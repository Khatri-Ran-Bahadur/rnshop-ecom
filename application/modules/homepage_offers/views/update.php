...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon white edit"></i><span class="break"></span>New Offers Options</h2>
			<div class="box-icon">
		...
		<div class="box-content">
			<p>Submit an Item ID. when you are finished adding a new offers, press 'Finished'</p>
			...
			<form class="form-horizontal" method="post" action="<?= $form_location ?>">
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="span6" name="item_id" placeholder="Enter an item ID">
						</div>
					</div>
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					$count=0;
						...
						<tr>
							<td><?= $count ?></td>
							<td class="center">Item ID:<?= $row->item_id ?> |  </td>
