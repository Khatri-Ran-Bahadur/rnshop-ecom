...
class Store_order_status extends MX_Controller 
{
    ...
    function _make_sure_delete_allowed($update_id)
    {
        ...
        //do NOT allow IF  has an order has this status
    ...
    $allowed=$this->_make_sure_delete_allowed($update_id);
     ...
     if($allowed==FALSE)
     {
        ...
        $flash_msg="The order status option was successfull deleted.";
    ...
    if($submit=="Submit"){
        ...
        if($this->form_validation->run()==TRUE){
            ...
            if(is_numeric($update_id)){
                ...
                //insert the new item
                $this->_insert($data);
                $update_id=$this->get_max();//get the ID of the new Order Status Option
