...
{
    /*
    NOTE; this makes sure no items on store_shoppertrack
    //..with the same session_id and shopper_id

    IF there ARe items on shoppertrack with same session_id and shopper_id
    ...
    */
    ...
    if($num_rows>0){//items conflicting with store_shoppertrack
        //regenerate the sesion if
        session_regenerate_id();
        //update/chenge the data['session_id'] variable
