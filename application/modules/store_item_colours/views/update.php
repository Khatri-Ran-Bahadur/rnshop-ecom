...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon white edit"></i><span class="break"></span>New Colour Options</h2>
			<div class="box-icon">
		...
		<div class="box-content">
			<p>Submit new option as required. when you are finished adding a new option, press 'Finished'</p>
