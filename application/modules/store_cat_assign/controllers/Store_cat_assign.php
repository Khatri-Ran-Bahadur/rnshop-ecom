...
function submit($item_id)
{
   ...
   if($submit=="Finished")
   {
    ...
    if($cat_id!="")
    {
        ...
        $flash_msg="The item was successfull assigned to the".$cat_title." category.";
...
function delete($update_id)
{
   ...
   $this->_delete($update_id);
    $flash_msg="The  option  was successfull deleted";
    $value='<div class="alert alert-success" role="alert">'.$flash_msg.'</div>';
...
function update($item_id)
{
   ...
   $this->load->module('site_security');
   $this->site_security->_make_sure_is_admin();
   //get an array of all sub categories on the assign
    $this->load->module('store_categories');
    $sub_categories=$this->store_categories->_get_all_sub_cats_for_dropdown();
   
    //get an all assigned categories
