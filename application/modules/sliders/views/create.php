...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
		 ...
		 <a href="<?= base_url() ?>sliders/deleteconf/<?= $update_id ?>"><button type="button" class="btn btn-danger">Delete Entire Sliders</button></a>
...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon white edit"></i><span class="break"></span>Sliders Details</h2>
			<div class="box-icon">
			...
			<form class="form-horizontal" method="post" action="<?= $form_location ?>">
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label" for="typeahead"> Sliders Title </label>
						<div class="controls">
