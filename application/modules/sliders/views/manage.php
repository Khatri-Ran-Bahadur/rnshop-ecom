...
if(isset($flash)){
 ...
 $create_item_url=base_url()."sliders/create"; ?><p style="margin-top: 30px;">
	<a href="<?= $create_item_url ?>"><button type="button" class="btn btn-primary">Create New Sliders</button></a>
</p>
<?php 
if($num_rows<1){
