<div style="background-color: #ddd; border-radius: 7px; margin-top: 24px; padding: 5px;">
	<?php
	...
	<table class="table">
		...
		<tr>
			<td colspan="2" style="text-align: center;">
				...
				<button class="btn btn-primary" type="submit" name="submit" value="Submit"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Add To Basket</button>
