...
function submit_ranking()
{
    ...
    $flash_msg="The enquiry ranking was successfull updated.";
...
{
    //make sure customer is allowed to be view/respond and fetch data
...
if($submit=="Cancel"){
    ...
    if($submit=="Submit"){
        ...
        if($this->form_validation->run()==TRUE){
            ...
            $this->_insert($data);
            $flash_msg="The message was successfull sent.";
            $value ='<div class="alert alert-success" role="alert">'.$flash_msg.'</div>';
            $this->session->set_flashdata('item', $value);
            redirect('enquiries/inbox');
        } 
...
function view()
{
    ...
    //set options for tha ranking dropdown
    $options['']="Select...";
    $options['1']="One Stars";
    $options['2']="Two Stars";
