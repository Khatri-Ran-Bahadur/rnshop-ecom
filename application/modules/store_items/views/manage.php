...
if(isset($flash)){
 ...
 $create_item_url=base_url()."store_items/create"; ?><p style="margin-top: 30px;">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered ">
						  ...
						  <tbody>
						  	...
						  	if($status==1){
						  		$status_lebel='success';
						  		$status_desc='Active';
						  	} else{
						  		$status_lebel='default';
						  ...
						  ?>
							<tr>
								...
								<td class="center">
									<span class="label label-<?=$status_lebel ?>"><?= $status_desc ?></span>
								</td>
								<td class="center">
