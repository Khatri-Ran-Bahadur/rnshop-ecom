	...
	<div class="box span12">
		...
		<div class="box-content">
			...
			if($got_gallery_pic==TRUE){
				...
				$delete_btn_info='Delete Main Item Image';
			}else{
				$gallery_btn_theme='primary';
				$delete_btn_info='Delete Item Image';
			}

			 if($big_pic==''){ ?>
		 <a href="<?= base_url() ?>store_items/upload_image/<?= $update_id ?>"><button type="button" class="btn btn-<?= $gallery_btn_theme ?>">Upload Item Image</button></a>
		 <?php 
			}else{ ?>
